...
clear str1 str2 str3 T T_t V_s R R_r                                        % Clearing tool variables. 
...
for set=min(behavioral_a.set):max(behavioral_a.set)                         % set 
    for i=min(behavioral_a.lvl):max(behavioral_a.lvl)                       % level !!!!!! I NEED TO DO SOMETHING REGARDING  
        try
        ...
        behavioral_a.zyklus(behavioral_a.ptcp==ptcp &...
            ...
            behavioral_a.lvl==i & behavioral_a.set==set)==3%do nothing
