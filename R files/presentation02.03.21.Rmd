...
This indicates that the task elicited a 5% mistake rate which left too small of a sample to capture significant differences between conditions. Or in other words, mistakes that when the stimuli occurred, it was not translated into a detriment for accuracy behavior. Is it possible to observe a change on behavior or physiology that could  
